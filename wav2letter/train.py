...
train_dataset = torchaudio.datasets.LIBRISPEECH(
    '../data', url='train-clean-100')

test_dataset = torchaudio.datasets.LIBRISPEECH('../data', url='test-clean')
...
def train(model, n_iter, lm):
    ...
    for epoch in range(last_epoch, config.epochs):
        ...
        test_and_log(model, test_loader, criterion, writer, n_iter, lm)
